...
public class Baton extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ExecuteCmdExprContext extends ExpressionContext {
		...
		public ExecuteCmdExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BatonListener ) ((BatonListener)listener).enterExecuteCmdExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BatonListener ) ((BatonListener)listener).exitExecuteCmdExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BatonVisitor ) return ((BatonVisitor<? extends T>)visitor).visitExecuteCmdExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				{
				_localctx = new ExecuteCmdExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(216);
				match(EXECUTE);
